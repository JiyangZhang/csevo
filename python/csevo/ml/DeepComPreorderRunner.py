...
class DeepComPreorderRunner:
    ...
    def __init__(self, work_dir: Path, use_latest: bool):
        ...
        self.model_data_dir: Path = Macros.data_dir/"models-data"/"DeepCom-Preorder"
        self.base_config_file: Path = Macros.python_dir/"configs"/"DeepCom-Preorder.yaml"
        return
