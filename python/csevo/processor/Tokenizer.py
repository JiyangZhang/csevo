...
class Tokenizer(object):
    ...
    def train(self, texts, max_vocab_size):
        ...
        self.vocab_size = min(max_vocab_size, len(self.word_count))
    ...
    def texts_to_sequences(self, texts, maxlen=50, padding='post', truncating='post', value=0):
